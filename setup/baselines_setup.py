...
#-------------------------------------------------------------
def baseline_setup(site, compound):
    """
    Set up the variables for the baseline classification models.
    This function extracts the meteorological data, reads the baseline flags, and combines them into a single dataset.

    Parameters:
    site (str): The AGAGE site to set up variables for.
    compound (str): The compound to set up variables for.
    ...
    print("Merge can get stuck. If it does, try rerunning the script.")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--compound', type=str, required=True, help='Input chosen compound (e.g., CH4, HFC-134a etc.).')
    ...
    # Validate compound
    compounds_lower = [c.lower() for c in cfg.compounds]   
    assert compound in cfg.compounds or compound in compounds_lower, f"Compound {compound} not recognised. Compounds can be updated in config.py."
