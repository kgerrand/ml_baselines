'''
Neural Network Final Model - Cape Matatula, American Samoa (SMO)
'''
#-------------------------------------------------------------
import pandas as pd
...
print(f"Creating a neural network model for {site}...")
...
print(f"Model created and saved: models/model_files/nn_model_{site}.joblib")
...
if os.path.exists(stats_csv_path):
    ...
    mask = ~((stats_df['site'] == site) & (stats_df['model_type'] == 'NN'))
